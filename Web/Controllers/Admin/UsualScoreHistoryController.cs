...
namespace Web.Admin.Controllers
{
    ...
    [ApiController]
    [Authorize]
    public class UsualScoreHistoryController : MyBaseController
    {
        IUsualScoreHistoryBll bll;
        public UsualScoreHistoryController(IUsualScoreHistoryBll bll)
        {
            this.bll = bll;
        }
        // GET: api/List/UsualScoreHistory
        [HttpGet]
        ...
        // Get: api/UsualScoreHistory/Delet/5
        [HttpGet("{id}")]
