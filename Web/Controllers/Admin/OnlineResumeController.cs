...
namespace Web.Admin.Controllers
{
    ...
    [ApiController]
    [Authorize]
    public class OnlineResumeController : MyBaseController
    {
        IOnlineResumeBll bll;
        public OnlineResumeController(IOnlineResumeBll bll)
        {
            this.bll = bll;
        }
        // GET: api/List/OnlineResume
        [HttpGet]
