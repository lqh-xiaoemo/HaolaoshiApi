...
namespace Web.Admin.Controllers
{
    ...
    [ApiController]
    [Authorize]
    public class ClasssController : MyBaseController
    {
        IClasssBll bll;
        public ClasssController(IClasssBll bll)
        {
            this.bll = bll;
        }
        // GET: api/List/Classs
