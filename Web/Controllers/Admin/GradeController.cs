...
namespace Web.Admin.Controllers
{
    ...
    [ApiController]
    [Authorize]
    public class GradeController : MyBaseController
    {
        IGradeBll bll;
        public GradeController(IGradeBll bll)
        {
            this.bll = bll;
        }
        // GET: api/List/Grade
