...
namespace Web.Redis
{
    ...
    public class RedisHelper
    {
        ...
        #region 构造函数
        public static RedisHelper Instance(int dbNum = 0)
        {
            return new RedisHelper(dbNum, null);
        }
        public static RedisHelper Instance(string readWriteHosts, int dbNum = 0)
        {
            return new RedisHelper(dbNum, readWriteHosts);
        }
